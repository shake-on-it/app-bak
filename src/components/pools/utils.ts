...
export const isGolfEntry = (entry: PoolEntry): entry is GolfMajorPickemEntry => golfMetaComparator(entry);

export const isGolfGame = (game: PoolGame): game is GolfMajorPickemGame => golfMetaComparator(game);
...
export const isNbaFaEntry = (entry: PoolEntry): entry is NbaFreeAgencyPickemEntry => nbaFaMetaComparator(entry);

export const isNbaFaGame = (game: PoolGame): game is NbaFreeAgencyPickemGame => nbaFaMetaComparator(game);
